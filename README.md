...
- `pnpm test`: Ejecuta todas las suites(menos el test:integration que requiere que realices el pago manual con stripe).
...
- `pnpm test:integration:efectivo`: Simulación del flujo de pago automatico.
